...
<head>
  ...
  <title>Delete - UNICOR CRUD</title>
</head>
<!-- component -->
  ...
  <div id="view" class="h-full w-screen flex flex-row bg-teal-700" x-data="{ sidenav: true }">
    ...
    <div class="flex items-center justify-center p-12 mx-32">
      ...
      <div class="mx-auto w-full max-w-[550px]">
        <form action="index.php?m=TABLA1DELETE" method="POST">
        <div class="mb-5">
            <input
              type="text"
              name="id"
          ...
          <div>
            <button
              class="hover:shadow-form rounded-md bg-red-700 py-3 px-8 text-base font-semibold text-white outline-none"
            >
              Eliminar
            </button>
          </div>
          <div>
            ATENCIÓN: Si va a eliminar un usuario debe asegurarse de que en la Tabla2 no haya vinculos hacía el usuario
            porque dará error
          </div>
        </form>
      </div>
