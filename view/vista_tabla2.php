...
<head>
  ...
  <title>Tabla 2 - UNICOR CRUD</title>
</head>
<!-- component -->
      ...
      <table class="border-collapse">
        <thead>
            <tr>
              ...
              <th class="p-3 font-bold uppercase bg-gray-200 text-gray-600 border border-gray-300 hidden lg:table-cell">fk id</th>
              ...
              <th class="p-3 font-bold uppercase bg-gray-200 text-gray-600 border border-gray-300 hidden lg:table-cell">Horario</th>
              <th class="p-3 font-bold uppercase bg-gray-200 text-gray-600 border border-gray-300 hidden lg:table-cell">Fecha</th>
              <th class="p-3 font-bold uppercase bg-gray-200 text-gray-600 border border-gray-300 hidden lg:table-cell">Unidades</th>
          ...
          ?>
            <tr class="bg-white lg:hover:bg-gray-100 flex lg:table-row flex-row lg:flex-row flex-wrap lg:flex-no-wrap mb-10 lg:mb-0">
                ...
                <td class="w-full lg:w-auto p-3 text-gray-800 text-center border border-b text-center block lg:table-cell relative lg:static">
                    ...
                    <a 
                      href="index.php?m=LINK_VER_UPDATE_TABLE2&id=<?php echo $item['id'] ?>&tabla1_id=<?php echo $item['tabla1_id'] ?>&descripcion=<?php echo $item['descripcion'] ?>&titulo=<?php echo $item['titulo'] ?>&horario=<?php echo $item['horario'] ?>&fecha=<?php echo $item['fecha'] ?>&unidades=<?php echo $item['unidades'] ?>&precio=<?php echo $item['precio'] ?>&email=<?php echo $item['email'] ?>" 
                      class="text-blue-400 hover:text-blue-600 underline"
                    >
                      Update
                    </a>
                    
                    <a href="index.php?m=LINK_VER_DELETE_TABLE2&id=<?php echo $item['id'] ?>&tabla1_id=<?php echo $item['tabla1_id'] ?>&descripcion=<?php echo $item['descripcion'] ?>&titulo=<?php echo $item['titulo'] ?>&horario=<?php echo $item['horario'] ?>&fecha=<?php echo $item['fecha'] ?>&unidades=<?php echo $item['unidades'] ?>&precio=<?php echo $item['precio'] ?>&email=<?php echo $item['email'] ?>"
