  ...
  <div id="view" class="h-full w-screen flex flex-row bg-teal-700" x-data="{ sidenav: true }">
    ...
    <div class="flex items-center justify-center px-40 ">
      ...
      <div class="mx-auto w-full max-w-[550px]">
        <form action="index.php?m=TABLA2UPDATE" method="POST">
          <div class="mb-5">
            <input
              type="text"
              name="id"
          ...
          <div>
            <button
              class="hover:shadow-form rounded-md bg-green-500 py-1 px-4 text-base font-semibold text-white outline-none"
            >
              Actualizar
            </button>
          </div>
