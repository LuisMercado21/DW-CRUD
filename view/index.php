...
<body class="font-poppins antialiased">
  <div id="view" class="h-full w-screen flex flex-row bg-teal-700" x-data="{ sidenav: true }">
    ...
    <div class="flex items-center justify-center">
      <img width="200" height="400" class="mx-80" src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/55/Universiordoba_Colombia.svg/800px-Universiordoba_Colombia.svg.png" alt=""> 
    </div>
    <!-- BIENVENIDA -->
